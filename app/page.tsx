...
const alsoLoveBooks = [
  {
    image: "https://kiddy-books.com/wp-content/uploads/2021/08/Starkids-book-cover-final-01-scaled.jpg",
    title: "STAR-KIDS",
    subtitle: "Solar System Exploration",
    description:
      "Zooming through the universe faster than the speed of light on their flying scooters and skateboards, these 10 fifth grade astronomy students are on a solar system odyssey.",
    link: "https://www.amazon.com/Star-Kids-Solar-System-Exploration/dp/B07DX9GLRT/",
  },
  {
    image: "https://kiddy-books.com/wp-content/uploads/2021/08/cover-scaled.jpg",
  ...
  {
    image: "https://kiddy-books.com/wp-content/uploads/2021/08/Claymates-v2-outer-corners-rounded.png",
    title: "CLAYMATES",
    ...
    <>
      ...
      <section style={{
        ...
        <div style={{ flex: "1 1 340px", maxWidth: 420 }}>
          ...
          <p style={{
            ...
            This ocean&apos;s storm sunk their tiny sailboat. Forced to swim to
            an abandoned isle, these 8 ninth-grade students have to exercise
            their survival skill This 57 page action-packed book is enjoyable
            for all ages.
          </p>
          <Link href="/e-books" style={{
        ...
        <div style={{ flex: "1 1 300px", display: "flex", justifyContent: "center" }}>
          ...
          <img
            src="https://kiddy-books.com/wp-content/uploads/2021/08/cover_juvenisle-768x1197.png"
            alt="Juven-Isle: Washed Ashore"
            style={{
              maxHeight: 520,
              maxWidth: "100%",
              objectFit: "contain",
      ...
      <style>{`
        @media (max-width: 768px) {
          .also-love-grid { grid-template-columns: 1fr !important; }
        }
      `}</style>
    </>
  );
